...
export const INSTRUCTIONS =
  ...
  "<p>You will <b>read the transcript word-by-word, pressing SPACEBAR to reveal each word.</b>  " +
  "When you have finished reading, you will <b>click the image</b> you think is being described.  " +
  "Then you will <b>find out if your selection is correct</b>.<p>" +
  '<center><img width="600px" src="assets/demo2.png" /></center></br>' +
  "<p>You will see <b>72 trials</b>. The image choices will be the same on each trial, and the descriptions will all be from the same group of participants.</p> " +
  "<p>Some of the transcripts may be much shorter or longer than others. " +
...
export const spr_instructions = "<p> Press space to reveal the next word. </p>";
export const select_instructions =
  "<p> Click on the image that was described. </p>";
