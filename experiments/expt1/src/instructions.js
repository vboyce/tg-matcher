...
export const CONSENT= ' <center><img width="300px" src="assets/stanford.png" /></center>'+
...
export const INSTRUCTIONS ='<h3>Please read these instructions carefully!</h3> </br>'+
...
'<p>You will see <b>36 trials</b>. The image choices will stay the same, but the transcripts '+
...
export const POST_SURVEY_QS= [
    {prompt: 'Were the instructions and task clear? '+
    'Was there anything you found confusing?', 
    name: 'understand', rows: 4},
    {prompt: 'How was the task length? Would you have '+ 
    ...
    {prompt: 'Were there any problems or errors with the experiment?',
     name: 'errors', rows:4},
    {prompt: 'Is there anything that would make the interface better?'+
    ' (ex. bigger text, or a different placement of text and buttons)', 
    name: 'interface', rows:4},
