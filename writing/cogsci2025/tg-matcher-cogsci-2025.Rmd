...
## Model results (+ calibration results??)
...
(?) What model results to include – rolling window / anti-rolling / etc ← is there anything good in the what parts of more important stuff (see incremental-analysis.Rmd, but also all the links broke)
