"""
This file contains the implementation of CLIP, from the paper "Abstract Visual Reasoning with 
Tangram Shapes" by Ji et al. We ended up not using this model, but the rest of our code depends
on it so we are including this file.
"""
...
class CLIPPreprocessor:
    ...
    def preprocess_images(self, images):
        preprocessed_images = []
        for image in images:
            preprocessed_images.append(self._image_preprocess(image.convert("RGB")))
